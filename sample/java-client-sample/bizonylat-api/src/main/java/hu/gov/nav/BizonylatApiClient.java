...
import hu.gov.nav.auth.Authentication;
import hu.gov.nav.auth.HttpBasicAuth;
import hu.gov.nav.auth.ApiKeyAuth;
...
@Component("hu.gov.nav.ApiClient")
public class BizonylatApiClient {
    ...
    private String basePath = "https://m2m-dev.nav.gov.hu/rest-api/1.0/";
    ...
    public BizonylatApiClient() {
        this.restTemplate = buildRestTemplate();
        init();
    }
    
    @Autowired
    public BizonylatApiClient(RestTemplate restTemplate) {
     ...
     */
    public BizonylatApiClient setBasePath(String basePath) {
     ...
     * @return ApiClient this client
     */
    public BizonylatApiClient setUserAgent(String userAgent) {
     ...
     * @return ApiClient this client
     */
    public BizonylatApiClient addDefaultHeader(String name, String value) {
     ...
     * @return API client
     */
    public BizonylatApiClient setDateFormat(DateFormat dateFormat) {
