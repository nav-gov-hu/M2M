...
public class CommonApiClient {
    ...
    private String basePath = "https://m2m-dev.nav.gov.hu/rest-api/1.1/";
    ...
    @Autowired
    public CommonApiClient(RestTemplate restTemplate) {
     ...
     */
    public CommonApiClient setBasePath(String basePath) {
     ...
     * @return ApiClient this client
     */
    public CommonApiClient setUserAgent(String userAgent) {
     ...
     * @return ApiClient this client
     */
    public CommonApiClient addDefaultHeader(String name, String value) {
     ...
     * @return API client
     */
    public CommonApiClient setDateFormat(DateFormat dateFormat) {
